...
public class TAF {
    ...
    protected Integer issueTime;
    @XmlElement(name = "bulletin_time")
    protected Integer bulletinTime;
    @XmlElement(name = "valid_time_from")
    protected Integer validTimeFrom;
    @XmlElement(name = "valid_time_to")
    protected Integer validTimeTo;
     ...
     *     
     */
    public void setIssueTime(Integer value) {
     ...
     *     
     */
    public Integer getBulletinTime() {
        return bulletinTime;
    }
     ...
     *     
     */
    public void setBulletinTime(Integer value) {
     ...
     *     
     */
    public Integer getValidTimeFrom() {
     ...
     *     
     */
    public void setValidTimeFrom(Integer value) {
     ...
     *     
     */
    public void setValidTimeTo(Integer value) {
