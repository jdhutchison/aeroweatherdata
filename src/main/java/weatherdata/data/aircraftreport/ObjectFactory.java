 ...
 * generated in the weatherdata.data.aircraftreport package.
...
public class ObjectFactory {
    ...
    private final static QName _NoTimeStamp_QNAME = new QName("", "no_time_stamp");
    ...
    private final static QName _AboveGroundLevelIndicated_QNAME = new QName("", "above_ground_level_indicated");
    private final static QName _VisibilityStatuteMi_QNAME = new QName("", "visibility_statute_mi");
    private final static QName _FltLvlRange_QNAME = new QName("", "flt_lvl_range");
    private final static QName _MidPointAssumed_QNAME = new QName("", "mid_point_assumed");
    private final static QName _AltitudeFtMsl_QNAME = new QName("", "altitude_ft_msl");
    private final static QName _RawText_QNAME = new QName("", "raw_text");
    private final static QName _ReceiptTime_QNAME = new QName("", "receipt_time");
    ...
    private final static QName _BadLocation_QNAME = new QName("", "bad_location");
    private final static QName _AircraftRef_QNAME = new QName("", "aircraft_ref");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: weatherdata.data.aircraftreport
     * 
     */
    ...
    public JAXBElement<String> createNoTimeStamp(String value) {
        return new JAXBElement<String>(_NoTimeStamp_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<String> createAboveGroundLevelIndicated(String value) {
        return new JAXBElement<String>(_AboveGroundLevelIndicated_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<Integer> createVisibilityStatuteMi(Integer value) {
        return new JAXBElement<Integer>(_VisibilityStatuteMi_QNAME, Integer.class, null, value);
    }
    ...
    public JAXBElement<String> createFltLvlRange(String value) {
        return new JAXBElement<String>(_FltLvlRange_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<String> createMidPointAssumed(String value) {
        return new JAXBElement<String>(_MidPointAssumed_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<Integer> createAltitudeFtMsl(Integer value) {
        return new JAXBElement<Integer>(_AltitudeFtMsl_QNAME, Integer.class, null, value);
    }
    ...
    public JAXBElement<String> createBadLocation(String value) {
        return new JAXBElement<String>(_BadLocation_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<String> createAircraftRef(String value) {
        return new JAXBElement<String>(_AircraftRef_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<Integer> createVertGustKt(Integer value) {
        return new JAXBElement<Integer>(_VertGustKt_QNAME, Integer.class, null, value);
    }
    ...
    public JAXBElement<String> createNoFltLvl(String value) {
        return new JAXBElement<String>(_NoFltLvl_QNAME, String.class, null, value);
    }
